...
var FullCalendar = (function (e) {
			...
			(function (e) {
				...
				t =
					!0 === e
						...
						: [];
				return (
					(t = t.map((e) => Object.assign(Object.assign({}, Jn), e))), t
				);
			})(e),
			null,
			t
	...
	class ei {
		...
		buildDateIncrement(e) {
			...
			return (
				n ||
				((t = this.props.dateAlignment) ? ht(1, t) : e || ht({ days: 1 }))
			);
		}
		refineRange(e) {
			if (e) {
				...
				("inverse-background" === u.display
					...
					: "none" !== u.display &&
					  ("background" === u.display ? a : l).push({
							...
							range: g,
							isStart:
								f.start && f.start.valueOf() === g.start.valueOf(),
	...
	class ys {
		...
		_sliceBusinessHours(e, t, n, r, ...i) {
			return e
				? this._sliceEventStore(Mn(e, bs(t, Boolean(n)), r), {}, t, n, ...i)
						.bg
				: [];
		}
			...
			!(
				...
				!(function (e, t, n, r) {
					let i = t.getCurrentData(),
						...
						c = pi(
							a,
							s.isEvent ? e.eventUiBases : { "": i.selectionConfig }
						);
					r && (c = Dt(c, r));
					let d =
							((g = e.eventStore),
	...
	function Ns(e, t, n) {
		...
		return (
			"GET" === e
				? (t +=
						(-1 === t.indexOf("?") ? "?" : "&") + new URLSearchParams(n))
			...
			(this.masterCallback = e),
				...
				(this.handleValue = (e, t) => {
					...
					null !== e
						...
						: ((n[t] -= 1),
						  n[t] ||
								(delete r[t], delete this.callbackMap[t], (i = !0))),
						this.masterCallback &&
							...
							if (
								...
								t.emitter.trigger(
									...
									Object.assign(Object.assign({}, l), {
										el: this.draggingSegEl,
										startDelta:
											this.validMutation.startDelta || ht(0),
			...
			return p(
				...
				b.map((e) => {
					let { seg: o, rect: l } = e,
						...
						u = Kl(l && l.span),
						v =
							!m && l ? this.computeSegHStyle(l) : { left: 0, right: 0 },
							...
							if (
								...
								r &&
									((i = {
										...
										isStart:
											e.isStart &&
											r.start.valueOf() === a.start.valueOf(),
										isEnd:
											e.isEnd && r.end.valueOf() === a.end.valueOf(),
										dayIndex: n,
									}),
									c.push(i),
									!i.isEnd &&
					...
					render() {
						const { context: e, props: t, state: n } = this,
							...
							a =
								Math.min(
									null != i
										? Math.floor(i / (r.multiMonthMinWidth + o))
										: 1,
					...
					updateSize() {
						...
						e &&
							...
							t &&
								...
								this.setState({
									monthHPadding:
										e.clientWidth - t.firstChild.offsetWidth,
								});
					}
					requestScrollReset() {
						(this.needsScrollReset = !0), this.flushScrollReset();
